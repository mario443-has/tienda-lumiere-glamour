...
function toggleFavorito(button, productoId) {
    ...
    console.log(`❤️ Producto ${productoId} ahora es favorito: ${isNowFavorite}`);
}
...
// --- Función para renderizar favoritos en la página de favoritos ---
...
// --- Solo cargar favoritos dinámicos si estamos en la página de favoritos ---
const favContainer = document.getElementById("favoritos-container");
if (favContainer) {
    renderFavoritesFromLocalStorage();
}
